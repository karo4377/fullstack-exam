...
2. **Database**
   ...
   - Run PostgreSQL (e.g. Docker: `docker run -e POSTGRES_USER=artshop -e POSTGRES_PASSWORD=artshop -e POSTGRES_DB=artshop -p 5433:5432 -d postgres:16`).
   - Create `.env` in the backend root:

   ```env
   DATABASE_URL="postgresql://artshop:artshop@localhost:5433/artshop"
